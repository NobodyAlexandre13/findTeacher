...
export const Select = styled(Picker)`
    ...
    margin-top: 10px;
`;
export const AreaDisciplina = styled.View`
    width: 100%;
    background-color: ${themes.colors.surface};
    width: 100%;
    border-radius: 5px;
    padding: 16px;
`;
export const AreaDisciplinaTitle = styled.View`
    flex-direction: row;
    flex-wrap: wrap;
    gap: 8px;
`;
export const DisciplinaTitle = styled.Text`
...
export const RemoveDisciplina = styled.TouchableOpacity`
    padding-left: 6px;
    border-radius: 10px;
    justify-content: center;
    align-items: center;
`;
export const AreaInputDisciplina = styled.View`
    flex-direction: row;
    justify-content: space-between;
`;

export const AreaInputDisciplinaText = styled.View`
    width: 78%;
`;

export const AddBtnAddDisciplina = styled.View`
    width: 18%;
`;